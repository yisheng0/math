...
class ThreeApp {
  ...
  takeSnapshot(position) {
    ...
    let shotCamera = new PerspectiveCamera(
      30,
  ...
  renderThreeViewsForObjects(objects, view) {
    ...
    const views = {
      ...
      top: {
        position: [center.x, center.y + cameraDistance, center.z],
        fov: 50,
      }, // 俯视图
      side: {
        position: [center.x + cameraDistance, center.y, center.z],
        fov: 50,
      }, // 侧视图
    };
